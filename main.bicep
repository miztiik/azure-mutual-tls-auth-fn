...
module r_cosmosdb 'modules/database/cosmos.bicep' = {
  name: '${cosmosdb_params.name_prefix}_${deploymentParams.loc_short_code}_${deploymentParams.global_uniqueness}_cosmos_db'
  params: {
    deploymentParams: deploymentParams
...
module r_sa 'modules/storage/create_storage_account.bicep' = {
  name: '${sa_params.name_prefix}_${deploymentParams.loc_short_code}_${deploymentParams.global_uniqueness}_sa'
  params: {
    deploymentParams: deploymentParams
    sa_params: sa_params
    tags: tags
...
module r_blob 'modules/storage/create_blob.bicep' = {
  name: '${sa_params.name_prefix}_${deploymentParams.loc_short_code}_${deploymentParams.global_uniqueness}_blob'
  params: {
    deploymentParams: deploymentParams
    sa_params: sa_params
...
module r_fn_app 'modules/functions/create_function.bicep' = {
  name: '${fn_params.app_name_prefix}_${deploymentParams.loc_short_code}_${deploymentParams.global_uniqueness}_fn_app'
  params: {
    deploymentParams: deploymentParams
...
module r_data_collection_endpoint 'modules/monitor/data_collection_endpoint.bicep' = {
  name: '${dce_params.name_prefix}_${deploymentParams.global_uniqueness}_dce'
  params: {
    deploymentParams: deploymentParams
...
module r_vm 'modules/vm/create_vm.bicep' = {
  name: '${vm_params.name_prefix}_${deploymentParams.global_uniqueness}_vm'
  params: {
    deploymentParams: deploymentParams
    uami_name_vm: r_uami.outputs.uami_name_akane
