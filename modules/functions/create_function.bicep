...
var __fn_svc_name = replace('${deploymentParams.enterprise_name_suffix}-${fn_params.app_name_prefix}-${deploymentParams.loc_short_code}-fn-plan-${deploymentParams.global_uniqueness}', '_', '-')
...
var __fn_app_name = replace('${deploymentParams.enterprise_name_suffix}-${fn_params.app_name_prefix}-${deploymentParams.loc_short_code}-fn-app-${deploymentParams.global_uniqueness}', '_', '-')
...
var __app_insights_name = replace('${deploymentParams.enterprise_name_suffix}-${fn_params.app_name_prefix}-${deploymentParams.loc_short_code}-app-insights-${deploymentParams.global_uniqueness}', '_', '-')
...
output r_app_insights_name string = r_applicationInsights.name
